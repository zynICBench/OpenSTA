...
//     // Range range = getRange(key.substr(pos + 1), inst_module->module);
//     // std::cout << range.left << " to " << range.right << std::endl;
//     std::string res = searchInModule("nvic_dbg_reg_addr_o[3]", ml);
